...
3. **Merge into MEMORY.md**
   ...
   - **Episodes section**: append new episode entries (timestamped, no dedup), then keep
     ...
     chronological order — to `.amp/remember/EPISODES.md` (create it with the header
...
- Episode archive: `.amp/remember/EPISODES.md` (episodes older than the 10 most recent — cold storage, never loaded into context)
