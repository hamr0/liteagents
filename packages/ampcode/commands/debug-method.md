...
1. **Create Failing Test Case**
   ...
   - The test must be observed failing BEFORE the fix, and for the right reason
...
- **AGENT_RULES.md → Testing Standards** - what makes the test real (poll, never sleep; no partial mocks)
