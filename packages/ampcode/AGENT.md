...
Ampcode is a lightweight CLI tool that provides workflow automation commands.
...
| docs-builder | Reorg a docs corpus, split an oversized doc, keep pages current, index them | /docs-builder [reorg \| cleanup <file.md>] | false |
