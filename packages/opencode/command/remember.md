...
3. **Merge into MEMORY.md**
   ...
   - **Episodes section**: append new episode entries (timestamped, no dedup), then keep
     ...
     chronological order — to `.opencode/remember/EPISODES.md` (create it with the header
...
- Episode archive: `.opencode/remember/EPISODES.md` (episodes older than the 10 most recent — cold storage, never loaded into context)
