...
- **`apply-reorg` also writes the docs pointer into `AGENTS.md`** — a marker-wrapped
...
entry-point docs (README, AGENTS.md, etc.). It prints the file's line count and an estimated
...
MEASURED, real (bareagent): before this, a split left `AGENTS.md`'s canonical-PRD reference
