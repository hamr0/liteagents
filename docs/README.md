...
| [`product/branch-review-README.md`](product/branch-review-README.md) | Guide to the `/branch-review` pre-merge gate — the four stages, what blocks a merge, and the fix ledger it feeds. |
